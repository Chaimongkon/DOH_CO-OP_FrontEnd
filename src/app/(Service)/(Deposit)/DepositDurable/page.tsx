...
const DepositDurable = () => {
  const { service, loading, error } = useServiceData("เงินฝากออมทรัพย์ยั่งยืน");
  const customLabels = ["แบบฟอร์มเงินฝากออมทรัพย์ยั่งยืน", "บันทึกข้อความเงินฝากออมทรัพย์ยั่งยืน"];
