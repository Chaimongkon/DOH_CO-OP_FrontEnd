...
function Information() {
  const [organizationals, setOrganizationals] = useState<Information[]>([]);
  ...
  const fetchOrganizational = useCallback(async () => {
    try {
      ...
      const filteredData = data.filter(
        (board: any) => board.Type === "ฝ่ายสารสนเทศ"
      );

      const processedData = filteredData.map((information: any) => ({
        id: information.Id,
