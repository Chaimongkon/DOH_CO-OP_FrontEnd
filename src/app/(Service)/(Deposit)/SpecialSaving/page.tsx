...
const SpecialSaving = () => {
  const { service, loading, error } = useServiceData("เงินฝากออมทรัพย์พิเศษ");
  const customLabels = ["แบบฟอร์มเงินฝากออมทรัพย์พิเศษ", "บันทึกข้อความเงินฝากออมทรัพย์พิเศษ"];
