//api/(Service)/DownloadForm/File/[...filePath]/route.tsx
...
export async function GET(req: NextRequest, { params }: { params: { filePath: string[] } }) {
  try {
    ...
    //const baseDir = 'C:/BackEndWeb/public/Uploads/FileDownload';
    const baseDir = process.env.NEXT_PUBLIC_URL_BASE_DIR + "/FileDownload";
    ...
    const fileExists = await fs.access(resolvedFilePath).then(() => true).catch(() => false);
    if (!fileExists) {
